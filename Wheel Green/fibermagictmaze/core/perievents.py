...
def perievents(df, logs, window, frequency):
    ...
    """
    #df = df.reset_index().set_index(['Mouse', 'Wheel', 'Channel', 'FrameCounter']) # Added by YB
    print ("TEST")
    print(df)
    ...
    for index, row in logs.iterrows():
        ...
        try:
            ...
            print('One trial ignored because there is no FP data available during that timestamp!')
